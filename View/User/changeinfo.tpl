...
<table width="99%" border="0">
  ...
  <tr>
    <td><div align="center" class="style1">【ユーザ情報変更】</div></td>
  </tr>
</table>
  ...
  <tr>
    <td width="4%">&nbsp;</td>
    <td width="92%"><div align="center"><span class="red"><strong><?php echo $this->formBean["err"]; ?></strong></span></div></td>
    <td width="4%">&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>ユーザID<br>
	  ...
	  <input type="hidden" name="user_id" value="<?php echo $this->formBean['user_id']; ?>" />	  </td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>名前<br><input name="name" type="text" value="<?php echo $this->formBean["name"]; ?>"></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>パスワード
<br><input name="password" type="text" value="<?php echo $this->formBean["password"]; ?>" size="4" maxlength="4" ></td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td>メールアドレス
<br>
<input name="email" type="text" value="<?php echo $this->formBean["email"]; ?>"></td>
    <td>&nbsp;</td>
  </tr>
    <? } ?>
  <tr>
