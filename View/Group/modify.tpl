...
<table width="99%" border="0">
  ...
  <tr>
    <td><div align="center" class="style1">【グループ変更登録】</div></td>
  </tr>
</table>

	<br>
	<form action=" <?php echo $this->formBean["to_modify"]; ?> " method="post">
	<table width="100%" border="1">
  <tr>
    <td width="4%">&nbsp;</td>
  ...
  <tr>
    <td>&nbsp;</td>
    <td><div align="center">
      <input type="submit" name="btn_change_name" value="       登録       ">
