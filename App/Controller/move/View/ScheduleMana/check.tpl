...
<body>
  ...
  <tr>
    <td><div align="center">【iスケジュール認証】</div></td>
  </tr>
  <tr>
...
<table width="99%" border="0">
  ...
  <tr>
	...
	<form action="<?php echo $this->formBean["to_check"]; ?>" method="post">
	<table width="100%" border="0">
  ...
  <tr>
    <td>&nbsp;</td>
    <td> <div align="center"><a href="<?php echo $this->formBean["go_back"]; ?>" accesskey="0" >戻る</a></div></td>
    <td>&nbsp;</td>
  </tr>
</table>
</form>
